    ...
    return (
        ...
        <div className="w-full flex justify-center">
            <div className="relative">
                ...
                />
                <input type="file" name="" id="avatar" className="hidden" accept="image/png. image/jpg, image/jpeg, image/webp" onChange={imageHandler}/>
                <label htmlFor="avatar">
                    <div className="w-[30px] h-[30px] bg-slate-900 rounded-full absolute bottom-2 right-2 flex items-center justify-center">
