                ...
                <div className="mt-[120px] p-8">
                    ...
                    <div className="w-full mt-8 p-6 bg-white dark:bg-[#111C43] rounded-lg shadow-md">
                        <p className="text-[18px] text-black dark:text-white">
                            Course analytics dashboard coming soon...
                        </p>
                        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-6 rounded-lg text-white">
                                <h3 className="text-[20px] font-semibold">Total Courses</h3>
                                <p className="text-[32px] font-bold mt-2">0</p>
                            </div>
                            <div className="bg-gradient-to-r from-green-500 to-green-600 p-6 rounded-lg text-white">
                                <h3 className="text-[20px] font-semibold">Published Courses</h3>
                                <p className="text-[32px] font-bold mt-2">0</p>
                            </div>
                            <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 rounded-lg text-white">
                                <h3 className="text-[20px] font-semibold">Course Views</h3>
                                <p className="text-[32px] font-bold mt-2">0</p>
                            </div>
                        </div>
                    </div>
